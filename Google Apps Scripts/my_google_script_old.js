...
const WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbzN9DtHwv8gvIp15lQcm2bJ0eXm4oqbm1t6Fn4s7dUCWvrZUfSoVJN9xQGrdK9edPw_2Q/exec';

// WordPress API (for pull method)
const WP_PULL_API_URL = 'https://crystalcapp.com/wp-json/api/v1/client-applications';
const WP_PUSH_API_URL = 'https://crystalcapp.com/wp-json/api/v1/client-applications/accepted';
...
function doGet() {
  try {
    var response = UrlFetchApp.fetch(WP_PULL_API_URL, {
      method: 'get',
    ...
    applications.forEach(function(app) {
      ...
      if(subId) {
        ...
        const indexSubId = processed.indexOf(subId);
        if (indexSubId !== -1) {
          processed.splice(indexSubId, 1);
        }
    ...
    if(submissionIds.length > 0) {
      acceptSubmissions(submissionIds);
    }
